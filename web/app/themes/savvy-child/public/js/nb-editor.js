...
var NbEditor = /*#__PURE__*/function () {
  ...
  _createClass(NbEditor, [{
    ...
    value: function register_document_events() {
      ...
      document.addEventListener('click', function (e) {
        if (!e.target.closest('.nb-dialog')) {
          _this2.dialog.classList.add('nb-display__none');
        }
        if (e.target.closest('.nb-block')) {
           ...
           * block on the editor.
           */
          if (_this2.content_wrap) {
            _this2.content_wrap.classList.remove('nb-display__none');
          }
          if (_this2.style_wrap) {
            _this2.style_wrap.classList.remove('nb-display__none');
          }
          _this2.nav_bar.classList.remove('nb-display__none');
          _this2.blocks_picker_wrap.classList.add('nb-display__none');
          Array.prototype.forEach.call(_this2.all_controls_wrap, function (control_wrap) {
            control_wrap.classList.remove('nb_display_block');
          });
          _this2.select_block(this_block);
          var selected_controls_wrap = _this2.editor.querySelectorAll('.nb-controls_wrap[data-blockid="' + this_block.dataset.blockid + '"]');
      ...
      document.addEventListener('contextmenu', function (e) {
        if (e.target.closest('.nb-block')) {
           ...
           */
          _this2.dialog.innerHTML = '';

          /**
           * Create Blocks Options
           */
          _this2.dialog.innerHTML = '<ul><li class="nb-blocks_options" data-option="delete">Delete</li></ul>';

          /**
           * Register Options Events.
           */
          Array.prototype.forEach.call(_this2.dialog.querySelectorAll('.nb-blocks_options'), function (option) {
            option.addEventListener('click', function () {
              ...
              switch (option.dataset.option) {
                case 'delete':
                  _this2.delete_block(this_block.dataset.blockid);
                  break;
                default:
                  break;
              }
           ...
           * Open Dialog Window.
           */
          _this2.dialog.style.left = e.clientX + 'px';
          _this2.dialog.style.top = e.clientY + 'px';
          _this2.dialog.classList.remove('nb-display__none');
        }
      }, false);
      ...
      document.addEventListener('mousemove', function (e) {
         ...
         */
        if (_this2.dragging_node && _this2.mouse_down) {
          /**
           * Check if dragging a block to move it.
           */
          if (_this2.dragging_node.classList.contains('nb-block')) {
            _this2.dragging_node.classList.add('nb-display__none');
          }
          _this2.cloned_picker.classList.remove('nb-display__none');
          _this2.cloned_picker.style.left = e.clientX + 10 + 'px';
          _this2.cloned_picker.style.top = e.clientY + 10 + 'px';
          _this2.insert_preselect_banner(e);
        }
      });
      ...
      document.addEventListener('mouseover', function (e) {
        ...
        if (e.target.closest('.nb-block')) {
          var this_block = e.target.closest('.nb-block');
          Array.prototype.forEach.call(_this2.blocks, function (block) {
          ...
          */
          if (!_this2.dragging_node) {
            _this2.show_hover_border(this_block);
          }
        }
      });
      ...
      document.addEventListener('mousedown', function (e) {
         ...
         */
        if (dragging_picker) {
          _this2.dragging_node = dragging_picker;
          _this2.set_cloner_picker(dragging_picker, e);
        }
         ...
         */
        if (dragging_block) {
          _this2.dragging_node = dragging_block;
          _this2.set_cloner_picker(_this2.editor.querySelector('.nb-editor_block_picker[data-blocktype="' + dragging_block.dataset.blocktype + '"]'), e);
        }
      });
      ...
      document.addEventListener('mouseup', function (e) {
        _this2.mouse_down = false;
        if (_this2.dragging_node) {
          /**
           * Return select control to the body of the 
           * document.
           */
          _this2.document_body.classList.remove('nb-status__noselect');
          /**
           * Remove the current cloned picker.
           */
          _this2.cloned_picker.remove();

          /**
           * Check if dragging a picker.
           */
          if (_this2.dragging_node.classList.contains('nb-editor_block_picker')) {
            /**
             * Create a new block.
             * 
             ...
             */
            _this2.create_new_block(_this2.dragging_node, e.target.closest('.nb-base'));
          }
          ...
          if (_this2.dragging_node.classList.contains('nb-block')) {
             ...
             * during the mousemove event.
             */
            _this2.move_block(_this2.dragging_node);

            /**
             * Make the block visible again.
             */
            _this2.dragging_node.classList.remove('nb-display__none');

            /**
             * Remove the Preselect Banner.
             */
            _this2.remove_preselect_banner();
          }
        }
    ...
    value: function register_block_picker_btn_events() {
      ...
      this.block_picker_btn.addEventListener('click', function () {
        if (_this3.content_wrap) {
          _this3.content_wrap.classList.add('nb-display__none');
        }
        if (_this3.style_wrap) {
          _this3.style_wrap.classList.add('nb-display__none');
        }
        _this3.nav_bar.classList.add('nb-display__none');
        _this3.blocks_picker_wrap.classList.remove('nb-display__none');
      });
    }
  }, {
    ...
    key: "insert_block",
    value: function insert_block(block_id, block_html, editor_controls_html) {
      var _this4 = this;
      /**
      ...
      Array.prototype.forEach.call(temp_controls, function (control) {
        if (control.classList.contains('nb_tab_content')) {
          if (_this4.content_wrap) {
            _this4.content_wrap.appendChild(control);
          }
        } else {
          if (_this4.style_wrap) {
            _this4.style_wrap.appendChild(control);
          }
        }
      });
      ...
      this.ajax_handler(args).then(function (data) {
        if (data.status == 'success') {
          switch (data.callback) {
            case 'insert_block':
              _this5.insert_block(data.block_id, data.block_html, data.editor_controls_html);
              break;
            default:
              break;
          }
    ...
    value: function register_hide_editor_events() {
      ...
      this.hide_editor_btn.addEventListener('click', function () {
        _this6.document_body.classList.toggle('nb-status_hide_editor');
      });
    }
    ...
    value: function register_editor_slide_events() {
      ...
      this.slide_editor.addEventListener('mousedown', function () {
        is_pressed = true;
        _this7.document_body.classList.add('nb-status__noselect');
      });
      document.addEventListener('mousemove', function (e) {
        if (is_pressed && e.clientX > 200 && e.clientX < 600) {
          _this7.document_body.style.marginLeft = e.clientX + 'px';
          _this7.editor.style.width = e.clientX + 'px';
        }
      });
      document.addEventListener('mouseup', function () {
        if (is_pressed) {
          _this7.document_body.classList.remove('nb-status__noselect');
          is_pressed = false;
        }
      });
    }
    ...
    value: function style_uof__select(control_wrap, selectors_wrap) {
      var _this8 = this;
      /**
      ...
      input.addEventListener('input', function () {
        Array.prototype.forEach.call(selectors_wrap.querySelectorAll('.nb-editor_selector'), function (selector) {
          var block_id = selector.closest('.nb-controls_wrap').dataset.blockid;
          var property = selector.dataset.property;
          var render = selector.dataset.selector + '{' + property.replace('{{VALUE}}', input.value) + '}';
          selector.setAttribute('data-renderedstyle', render);
          _this8.render_block_style(block_id);
        });
        _this8.check_all_blocks_conditions(control_wrap.closest('.nb-controls_wrap'));
      });
    }
  }, {
    key: "style_uof__text",
    value: function style_uof__text(control_wrap, selectors_wrap) {
      var _this9 = this;
      ...
      input.addEventListener('input', function () {
        Array.prototype.forEach.call(selectors_wrap.querySelectorAll('.nb-editor_selector'), function (selector) {
          ...
          var render = selector.dataset.selector + '{' + property.replace('{{VALUE}}', input.value) + '}';
          selector.setAttribute('data-renderedstyle', render);
          _this9.render_block_style(block_id);
        });
    ...
    value: function update_selectors_on_the_fly(control_wrap, selectors_wrap) {
      switch (control_wrap.dataset.type) {
        case 'select':
          this.style_uof__select(control_wrap, selectors_wrap);
          break;
        case 'text':
          this.style_uof__text(control_wrap, selectors_wrap);
          break;
        default:
          break;
      }
    ...
    value: function register_controls_events() {
      ...
      Array.prototype.forEach.call(this.all_controls, function (control_wrap) {
         ...
         */
        if (_this10.registered_controls.includes(control_wrap)) {
          return;
        } else {
          _this10.registered_controls.push(control_wrap);
        }

        /**
         * Update Style on the Fly (Render Stlyes).
         */
        if (control_wrap.querySelectorAll('.nb-editor_selector').length > 0) {
          _this10.update_selectors_on_the_fly(control_wrap, control_wrap.querySelector('.nb-editor_selectors'));
        } else {
          /**
           * 
          ...
          if (control_wrap.dataset.uof) {
            _this10.update_on_the_fly(control_wrap);
          }
        }
        ...
        if (control_wrap.dataset.hasconditions) {
          _this10.check_conditions_for_control(control_wrap);
        }
      });
    }
  }, {
    ...
    value: function content_uof__select(control_wrap) {
      ...
      var input = control_wrap.querySelector('select');
      input.addEventListener('input', function () {
        _this12.uof_ajax_caller(control_wrap);
        _this12.check_all_blocks_conditions(control_wrap.closest('.nb-controls_wrap'));
      });
    }
    ...
    value: function collect_controls_values(controls_wrap_list) {
      ...
      Array.prototype.forEach.call(controls_wrap_list, function (controls_wrap) {
        ...
        Array.prototype.forEach.call(controls, function (control) {
          ...
          switch (control_type) {
            case 'text':
              value = _this13.collect_data_from_control__text(control);
              break;
            case 'select':
              value = _this13.collect_data_from_control__select(control);
              break;
            default:
              break;
          }
    ...
    value: function collect_controls_data(controls_wrap_list) {
      var _this14 = this;
      console.log('Controls Wrap');
      console.log(controls_wrap_list);
      var blocks = {};
      Array.prototype.forEach.call(controls_wrap_list, function (controls_wrap) {
        ...
        blocks[block_id]['controls_values'] = _this14.collect_controls_values(controls_wrap_list);
      });
      return blocks;
    }
  }, {
    ...
    value: function uof_ajax_caller(control_wrap) {
      ...
      console.log(block_data_object);
      this.ajax_handler(args).then(function (data) {
        if (data.status == 'success') {
          if (typeof data.callback != 'undefined') {
            switch (data.callback) {
              case 'update_block':
                _this15.update_block(data.block_id, data.html_content);
                break;
              default:
                break;
            }
    ...
    value: function collect_block_data(blocks_list) {
      ...
      Array.prototype.forEach.call(blocks_list, function (block) {
        ...
        var controls_data = {};
        var controls_wrap_list = _this16.editor.querySelectorAll('.nb-controls_wrap[data-blockid="' + block.dataset.blockid + '"]');
        var controls_values = _this16.collect_controls_values(controls_wrap_list);
        ...
        if (block.children.length > 0) {
          controls_data['children'] = _this16.collect_block_data(block.children);
        }
    ...
    value: function collect_node_wraps_data() {
      ...
      Array.prototype.forEach.call(noder_wraps_list, function (noder_wrap) {
        ...
        var controls_data = _this17.collect_wrappers_data(noder_wrap);
    ...
    value: function register_update_btn_events() {
      ...
      this.update_post_btn.addEventListener('click', function () {
        var noder_wraps_data = _this18.collect_node_wraps_data();
        var styles_object = _this18.create_styles_object();
        ...
        _this18.ajax_handler(args).then(function (data) {
          if (data.status == 'success') {
            console.log('Success');
          } else {
            console.log('Error received from server');
    ...
    value: function delete_block(block_id) {
      ...
      Array.prototype.forEach.call(block.children, function (descendent) {
        if (descendent.classList.contains('nb-block')) {
          _this19.delete_block(descendent.dataset.blockid);
        }
      });
    ...
    value: function register_nav_bar_events() {
      ...
      Array.prototype.forEach.call(this.nav_bar_links, function (link) {
        link.addEventListener('click', function () {
           ...
           */
          Array.prototype.forEach.call(_this20.tab_contents, function (content) {
           ...
           */
          Array.prototype.forEach.call(_this20.nav_bar_links, function (this_link) {
           ...
           */
          _this20.editor.querySelector('.nb-editor_tab_content_' + link.dataset.tab).classList.add('nb_display_block');
        });
      });
    }
  }, {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkprivacysavvy"] = self["webpackChunkprivacysavvy"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["src/sass/temp/.sass-fcp-archive-output","src/sass/temp/.sass-fcp-single-output","src/sass/temp/.sass-fcp-home-output","src/sass/temp/.sass-output","public/css/nb-editor","assets/css/ps-lrc","assets/css/ps-fcp-archive","assets/css/ps-fcp-single","assets/css/ps-fcp-home","assets/css/all","src/sass/temp/.sass-lrc-output"], () => (__webpack_require__("./app/SavvyBuilder/src/js/editor.js")))
...
/******/ 	__webpack_require__.O(undefined, ["src/sass/temp/.sass-fcp-archive-output","src/sass/temp/.sass-fcp-single-output","src/sass/temp/.sass-fcp-home-output","src/sass/temp/.sass-output","public/css/nb-editor","assets/css/ps-lrc","assets/css/ps-fcp-archive","assets/css/ps-fcp-single","assets/css/ps-fcp-home","assets/css/all","src/sass/temp/.sass-lrc-output"], () => (__webpack_require__("./src/sass/fcp-archive.scss")))
...
/******/ 	__webpack_require__.O(undefined, ["src/sass/temp/.sass-fcp-archive-output","src/sass/temp/.sass-fcp-single-output","src/sass/temp/.sass-fcp-home-output","src/sass/temp/.sass-output","public/css/nb-editor","assets/css/ps-lrc","assets/css/ps-fcp-archive","assets/css/ps-fcp-single","assets/css/ps-fcp-home","assets/css/all","src/sass/temp/.sass-lrc-output"], () => (__webpack_require__("./src/sass/temp/.sass-fcp-archive-output.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["src/sass/temp/.sass-fcp-archive-output","src/sass/temp/.sass-fcp-single-output","src/sass/temp/.sass-fcp-home-output","src/sass/temp/.sass-output","public/css/nb-editor","assets/css/ps-lrc","assets/css/ps-fcp-archive","assets/css/ps-fcp-single","assets/css/ps-fcp-home","assets/css/all","src/sass/temp/.sass-lrc-output"], () => (__webpack_require__("./src/sass/temp/.sass-lrc-output.css")))
